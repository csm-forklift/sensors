...
void setup() {
  ...
  if (!bno0.begin(Adafruit_BNO055::OPERATION_MODE_IMUPLUS)) {
  ...
  bno0.setMode(Adafruit_BNO055::OPERATION_MODE_IMUPLUS);
  // IMU1, accelerometer
  ...
  bno1.setMode(Adafruit_BNO055::OPERATION_MODE_IMUPLUS);
